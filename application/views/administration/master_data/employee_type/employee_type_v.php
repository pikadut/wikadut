    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <a class="btn btn-primary" href="<?php echo site_url('administration/master_data/employee_type/add_employee_type') ?>" role="button">Tambah</a>               

            <table id="employee_type" class="table table-bordered table-striped"></table>
