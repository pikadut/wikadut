    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
              <div class="col-sm-3">
              <form class="form-horizontal" method="post" action="<?php echo site_url('commodity/katalog/katalog_barang/add');?>">
              ...
              <div class="col-sm-9">
                <div class="btn-group pull-right">
                  ...
                  <a href="<?php echo site_url('commodity/katalog/katalog_barang/edit');?>" class="btn btn-info btn-flat">Ubah</a>
                  
                  <a href="<?php echo site_url('commodity/katalog/katalog_barang/delete');?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-info btn-flat">Nonaktifkan</a>
...
$table.bootstrapTable({
  ...
  url: "<?php echo site_url('Commodity/data_mat_catalog') ?>",
...
$table.on('check.bs.table  check-all.bs.table', function () {
  ...
  $.ajax({
    url:"<?php echo site_url('Commodity/selection/selection_mat_catalog') ?>",
    data:param,
    type:"get"
  });
