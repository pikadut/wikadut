    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
              <div class="col-sm-3">
              <form class="form-horizontal" method="post" action="<?php echo site_url('commodity/katalog/grup_barang/add');?>">
  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      $table.on('check.bs.table  check-all.bs.table', function () {
        ...
        $.ajax({
          url:"<?php echo site_url('Commodity/selection/selection_mat_group') ?>",
          data:param,
          type:"get"
        });
  ...
  //console.log(name, args);
    ...
    function responseHandler(res) {
      $.each(res.rows, function (i, row) {
        row.state = $.inArray(row.mat_group_code, selections) !== -1;
      });
      return res;
    }
	...
	function loadLevel2AndBelow(){
		$.ajax({
				url:"<?php echo site_url('Commodity/dropdown_grup_brg?parent='); ?>"+$("#level_1").val(),
				type:"get",
				dataType:"json",
				success: function(data) {
				$.each(data, function(index, row) {
	...
	function loadLevel3AndBelow(){
		$.ajax({
					url:"<?php echo site_url('Commodity/dropdown_grup_brg?parent=') ?>"+$("#level_2").val(),
					type:"get",
					dataType:"json",
					success: function(data) {
					$.each(data, function(index, row) {
	...
	function refreshDatatable(){
		$table.bootstrapTable('refresh', {url: "<?php echo site_url('Commodity/data_grup_brg?parent=') ?>"+$("#level_3").val()});
	}
