    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Rekapitulasi Pengiriman Tiket</h5>
...
<script type="text/javascript">
  ...
  function operateFormatter(value, row, index) {
    var link = "<?php echo site_url('tiket/permintaan_tiket/rekapitulasi_pengiriman_tiket') ?>";
    return [
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table_permintaan_tiket.bootstrapTable({
      ...
      url: "<?php echo site_url('tiket/data_pengiriman_tiket/lihat') ?>",
