...
<form method="post" action="<?php echo site_url($controller_name."/submit_approval_permintaan_tiket");?>"  class="form-horizontal ajaxform">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <?php $curval=$permintaan['tpm_number']; ?>
                        ...
                        <?php $curval=$permintaan['tpm_district_name']; ?>
                        <div class="form-group">
                        ...
                        <?php $curval=$permintaan['tpm_planner']; ?>
                        <div class="form-group">
...
include(VIEWPATH."/comment_workflow_attachment_v.php") ?>
  ...
  <?php echo buttonsubmit('tiket/permintaan_tiket/rekapitulasi_permintaan_tiket',lang('back'),lang('save')) ?>
