    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Daftar Rekapitulasi Penerimaan Tiket</h5>
...
<script type="text/javascript">
  ...
  function operateFormatter(value, row, index) {
    var link = "<?php echo site_url('tiket/permintaan_tiket/rekapitulasi_penerimaan_tiket/') ?>";	
    return [
    '<a class="btn btn-primary btn-xs action" href="'+link+'/detail/'+value+'">',
    'Lihat',
    '</a>',
  ].join('');
}
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table_permintaan_tiket.bootstrapTable({
      ...
      url: "<?php echo site_url('tiket/data_penerimaan_tiket/lihat') ?>",
      cookieIdTable:"daftar_penerimaan_tiket",
      idField:"trm_id",
