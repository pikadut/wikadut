<div class="wrapper wrapper-content animated fadeInRight">
  <form method="post" action="<?php echo site_url($controller_name."/submit_ubah_permintaan_tiket");?>"  class="form-horizontal ajaxform">
      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          ...
          <div class="ibox-content">
            ...
            <?php $curval = (isset($permintaan['tpm_planner'])) ? $permintaan['tpm_planner'] : $userdata['complete_name']; ?>
             <div class="form-group">
           ...
           <?php $curval = (isset($permintaan['tpm_district_name'])) ? $permintaan['tpm_district_name'] : $userdata['district_name']; ?>
          <div class="form-group">
