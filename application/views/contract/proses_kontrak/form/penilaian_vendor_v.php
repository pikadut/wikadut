        ...
        <table class="table table-bordered table-responsive">
          ...
          <tbody><?php if (strlen($kode_item['item_code']) == 14){?>
            ...
            <tr <?php if(strlen($value['kode']) <= 3){?> style="color: #000; font-size: 30pt; font-weight: bold;" <?php }?>>
             ...
             <td><input type="radio" name="jawaban[<?php print $i; ?>]" value="1" id="ya" required> IYA</td>
             <td><input type="radio" name="jawaban[<?php print $i; ?>]" value="0"  id="tidak" required> TIDAK</td>
             <?php } else {?>
             <td>
