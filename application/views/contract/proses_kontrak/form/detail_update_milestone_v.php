...
<div class="row">
  <div class="col-lg-12">
    ...
    <div class="ibox float-e-margins">
      <div class="ibox-title">
        <h5>DETAIL UPDATE MILESTONE / TERMIN PEMBAYARAN</h5>
          ...
          <div class="col-sm-5">
            <div class="input-group">
              <span class="input-group-btn">
                <button type="button" data-id="milestone_file_inp" data-folder="<?php echo "contract/milestone" ?>" data-preview="preview_file" class="btn btn-primary upload">...</button> 
              </span> 
              <input readonly type="text" class="form-control" id="milestone_file_inp" name="milestone_file_inp" value="">
              <span class="input-group-btn">
                <button type="button" data-url="<?php echo INTRANET_UPLOAD_FOLDER."/contract/milestone/$curval" ?>" class="btn btn-primary preview_upload" id="preview_file">Lihat</button> 
              </span> 
            </div>
          </div>
        </div>
  ...
  <div class="ibox float-e-margins">
    <div class="ibox-title">
      <h5>KOMENTAR PROGRESS MILESTONE / TERMIN PEMBAYARAN</h5>
