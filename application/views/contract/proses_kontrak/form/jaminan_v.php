    ...
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input class="form-control" name="nama_bank_inp" value="<?php echo $curval ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input class="form-control" name="no_jaminan_inp" value="<?php echo $curval ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <div class="input-group date">
              ...
              <input type="date" name="mulai_berlaku_inp" class="form-control" value="<?php echo $curval ?>">
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <div class="input-group date">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input type="date" name="berlaku_hingga_inp" class="form-control" value="<?php echo $curval ?>">
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input class="form-control money" name="nilai_jaminan_inp" value="<?php echo $curval ?>">
          </div>
        </div>
