                    ...
                    <div class="ibox-content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group">
                            ...
                            <span class="input-group-btn">
                              ...
                              <!-- haqim -->
                              <button type="button" data-url="<?php echo site_url('log/download_attachment/'.$dir.'/'.$curval) ?>" class="btn btn-primary preview_upload" id="preview_file_<?php echo $k ?>">
                                <i class="fa fa-share"></i>
                              </button> 
                        ...
                        <div class="col-sm-3">
                          ...
                          <select class="form-control" name="doc_type_inp[<?php echo $k ?>]">
