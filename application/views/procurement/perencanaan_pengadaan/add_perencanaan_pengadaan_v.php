<div class="wrapper wrapper-content animated fadeInRight">
  <form method="post" action="<?php echo site_url($controller_name."/submit_pembuatan_perencanaan_pengadaan");?>"  class="form-horizontal ajaxform">
    ...
    <div class="row">
      <div class="col-lg-12">
       ...
       <div class="col-sm-1">
        ...
        <button type="button" data-id="mata_anggaran_inp" data-url="<?php echo site_url('administration/picker_anggaran') ?>" class="btn btn-primary picker">
          <i class="fa fa-search"></i>
        </button> 
