...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table.bootstrapTable({
      url: "<?php echo site_url('Procurement/data_sanggahan/new') ?>",
...
function responseHandler(res) {
  $.each(res.rows, function (i, row) {
    row.state = $.inArray(row.pcl_id, selections) !== -1;
  });
  return res;
}
...
function detailFormatter(index, row) {
  ...
  var mydata = $.getCustomJSON("<?php echo site_url('Procurement/alias_sanggahan') ?>");
