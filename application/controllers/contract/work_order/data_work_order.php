...
$this->db->where("A.ccc_activity",2901);
...
$this->db->select("ccc_id,A.contract_id,A.ptm_number,contract_number,subject_work,vendor_name,contract_type,awa_name as activity,DATE_FORMAT(ccc_start_date,'%d/%m/%Y %H:%i') as waktu,contract_amount");
