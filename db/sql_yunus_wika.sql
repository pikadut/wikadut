...
---31/07/2018
ALTER TABLE "public"."prc_pr_main" 
  ADD COLUMN "pr_packet" varchar(255);
...
ALTER TABLE "public"."prc_tender_main" 
  ADD COLUMN "ptm_packet" varchar(255);
...
CREATE VIEW "public"."vw_daftar_pekerjaan_rfq" AS  SELECT a.ptc_id,
    ...
    to_char(a.ptc_start_date, 'YYYY-MM-DD HH24:MI:SS'::text) AS waktu,
    a.ptc_pos_code,
...
ALTER TABLE "public"."vw_daftar_pekerjaan_rfq" OWNER TO "postgres";